...
if __name__ == '__main__':
    ...
    arg('--weights-dir', type=str, default="./CNN/weights", help="path to directory with checkpoints")
    ...
    arg('--output', type=str, required=False, help="path to output csv", default="./CNN/submission.csv")
    ...
    predictions = predict_on_video_set(face_extractor=face_extractor, input_size=input_size, models=models,
                                       ...
                                       num_workers=4, test_dir=args.test_dir)
